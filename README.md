...
Working through the **42 common core** — a deep dive into C, Unix, shell, memory management, and algorithms. The kind of fundamentals that make you a better developer in every other language too.

On the side, I write **Python**: OOP, Pydantic, packaging, virtual environments, and small projects that scratch whatever itch I have that week.
...
- Writing cleaner, more idiomatic C
- Better Git workflows on collaborative projects
- The space where data engineering and software engineering overlap

## 📌 Pinned projects

A mix of 42 coursework and personal projects — feel free to look around 👇
...
📫 Always happy to chat about data, low-level programming, or what's worth seeing in Berlin.
